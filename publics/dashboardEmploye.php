...
<body>
<nav id="nav">
    <span><h2 class="dashboard">Dashboard<span class="role">/employé</span></h2><strong class="nomUser"><?php echo $_SESSION['utilisateur']['nom'];?></strong></span>
    <div class="nav-left">
        
        <span><a href="gestionClientEmploye.php"><i class="fa-solid fa-users"></i>Gestion clients</a></span>
        <span><a href="gestionVoitureEmploye.php"><i class="fa-solid fa-car"></i>Gestion voitures</a></span>
